...
|---|---|---|
| Skill directory | path | Path to the skill to update |
| Change description | string | What changed and why |
| Bump type | string | `major`, `minor`, or `patch` |
...
| Generated by | string | agent name | Tool or model that generated the change |
...
|---|---|---|
| `SKILL.md` | Markdown | Updated version in frontmatter |
| `changelog.md` | Markdown | New release entry at the top |
